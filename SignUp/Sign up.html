...
<body>
  <form>
    ...
    <div class="button">
        <div class="inner"></div>
        <button onclick=" validateForm()" > <a href="../Home/index.html" style="text-decoration: none;color: white;font-size:16px;">Sign Up</a></button>
    </div>
  ...
  <script>
    alert ("If you want to leave this page without registering, just click on the logo.");
